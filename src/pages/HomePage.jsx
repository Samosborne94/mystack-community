    ...
    <div className='flex flex-col h-full'>
      <Card.Header>
        <div className='flex items-start justify-between'>
          ...
          <span className='ml-3 text-lg font-bold text-primary-400'>
            ${price}
          </span>
        </div>
      </Card.Header>
      ...
      <div className='space-y-16'>
          ...
          <div className='bento-grid'>
            <div className='bento-item-small'>
              <StatCard
                ...
                value={formatNumber(mockStats.total_prompts)}
                icon='⚡'
              />
            </div>
            <div className='bento-item-small'>
              <StatCard
                ...
                value={formatNumber(mockStats.active_users)}
                icon='😊'
              />
            </div>
            <div className='bento-item-small'>
              <StatCard
                label='Total Sales'
                value={`$${formatNumber(mockStats.total_sales)}`}
                icon='💰'
              />
            </div>
          </div>
        ...
        <section>
          <div className='text-center mb-12'>
            ...
            <p className='text-gray-400 text-lg'>
              Find prompts tailored to your specific needs
            </p>
          </div>
          ...
          <div className='bento-grid'>
            {mockContentItems.slice(0, 6).map((item, index) => (
              <div
                key={item.id}
                className={
                  index === 0 ? 'bento-item-large' : 'bento-item-small'
                }
              >
        ...
        <section className='text-center py-20'>
          <Card className='max-w-4xl mx-auto'>
            <Card.Header>
              <Card.Title className='text-4xl mb-4'>
                Ready to Get Started?
              </Card.Title>
              <Card.Description className='text-lg'>
                Join the community and start discovering amazing AI prompts
                today
              </Card.Description>
            </Card.Header>
            <Card.Content>
